...
- **Three new Boons: Launch Pad, Barrel Cannon & Slingshot Rings.** A trio of helpful placeables that send you flying. Drive over a **Launch Pad** to be flung through the air in the direction it points — while you're airborne nothing can touch you (lava and hazards included), and you land wherever the arc drops you, so authors aim it across gaps and over danger. A **Barrel Cannon** scoops you in and holds you with a **burning fuse**: while you're loaded you can **aim** — turn left/right to swing the barrel — and **press punch to fire** in that direction, or let the fuse burn down and it launches you automatically. It's a longer, committed flight than the Launch Pad (an aim arrow shows where you'll go), and in the editor a dotted line previews roughly where a racer lands so authors can place it. **Slingshot Rings** give you a speed burst as you drive *through* them, along the ring's axis; the more **centered** your pass, the bigger the kick, and hitting a **row of rings** in quick succession stacks the boost into a real launch. Authors place all three from the **Boons** palette and rotate them to aim; as with every boon, rival AI racers drive straight through them, and each switches to a watery look when placed on water.
