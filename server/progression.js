...
var ACHIEVEMENT_UNLOCKS = [
    ...
    { id: 'bolt', name: "Bolt", slot: 'trail', stat: 'zombieKills', threshold: 20 },
    { id: 'neon', name: "Neon", slot: 'trail', stat: 'zombieKills', threshold: 75 },
    ...
    { id: 'gear', name: "Gear", slot: 'cart', stat: 'windupPunchHits', threshold: 25 },
    { id: 'dino', name: "Dino", slot: 'cart', stat: 'windupPunchHits', threshold: 100 },
    ...
    { id: 'border_spikes', name: "Spikes", slot: 'border', stat: 'bumpersHit', threshold: 50 },
    { id: 'border_sawblade', name: "Sawblade Rim", slot: 'border', stat: 'bumpersHit', threshold: 250 },
    { id: 'ripple', name: "Ripple", slot: 'trail', stat: 'iceDistance', threshold: 2000 },
    { id: 'border_glow', name: "Glow", slot: 'border', stat: 'iceDistance', threshold: 10000 },
