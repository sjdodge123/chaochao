        ...
        },
        {
            ...
            entries: [
                ...
                { id: "brutal-bunker", name: "Bunker", icon: svg("bunker-door.svg"), anim: "bunker",
                  ...
                  detail: "The goal sinks underground behind a silo door, so there's nothing to race to. There's a short calm beat to read the arena, then a wall of lava begins closing in from every edge — a slow, steady squeeze now, not a sudden flood — herding everyone together. It's a battle royale: outlive the rest and the silo bursts open for you to claim the win, and the game always carves a walkable path through the lava so the risen goal can never be left stranded out of reach. Zombies don't count as survivors, so an infected horde can't keep the goal buried — and you can't stall it out either: camp too long and the round simply voids with no winner." },
        ...
        },
        {
            ...
            entries: [
                ...
                { id: "hazard-vortexwell", name: "Vortex Well", icon: art("vortexWell"), anim: "vortexWell",
                  ...
                  detail: "The opposite of a bumper: it pulls everything inside its ring toward the centre. Carry enough speed and you slingshot right past, but get caught crawling and you're reeled in — which is why you'll often find one parked over lava or just off the fast line. The very centre is a true dead spot, though — a genuinely calm eye with no pull at all: if you get reeled in, rest there to wind up speed, then power back out through the ring. And over deep water a well can't grip you — you swim straight through, since a swimmer could never out-stroke the pull anyway." },
        ...
        },
        {
            ...
            entries: [
                { id: "medal-intro", name: "About Medals", icon: emoji("🏅"), anim: "medalShine",
                  ...
                  detail: "When the match wraps, the game looks back over everything that happened and hands out medals for how each racer played — who racked up kills, who kept reaching the goal, who couldn't catch a break. They're bragging rights — and the skill medals also unlock cosmetic skins as you earn them over many matches. While you race, a little ticker in the bottom-left corner ties the two together: pull off a kill, a fully-charged punch or a bumper bounce and it pops \"+1\", showing your lifetime progress toward the next skin that skill unlocks (\"Heavy Hitter 6 / 20 → Gear\") plus how many you've notched this match. Hold the medal at match-end and it banks for real — the bar advances and flashes the skin's name the moment you cross an unlock. (Signed-in players see the lifetime bar; guests just get the pop.)" },
