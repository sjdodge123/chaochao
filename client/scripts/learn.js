        ...
        },
        {
            ...
            entries: [
                ...
                { id: "tile-bumper", name: "Bumpers", icon: art("bumper"), anim: "bumper",
                  ...
                  detail: "Bump one and you're flung away — maddening in a hurry, but a clever way to launch a chasing rival off their line. Some maps add moving bumpers that sweep across the track, so the safe lane keeps shifting, and some stretch the same springy sting into a bumper wall — a whole pinball-style line that kicks you straight off its face, great for shrugging karts back onto the racing line or guarding a shortcut. Other maps mount a bumper on a spinning arm — a rotor — that sweeps a full circle around its pivot like a clock hand, so the safe moment comes round and round. And watch the ground for geysers — vents that sit quiet, then bubble up a warning and erupt, launching anyone standing on or near them; the telegraph is your cue to step off. Proximity mines play the opposite game: they wait, armed and silent, until a kart strays too close, then blink down a quick fuse and blow up, flinging the whole nearby pack — so springing one as the leader can wreck the racers right behind you. Rival AI racers time the moving sweeps like you do — they hold at the edge of the bumper's path and dart through behind it, favoring the ends of its run where the gap stays open longest, they dash across a rotor's ring between passes, and they steer wide of walls rather than ride them." },
