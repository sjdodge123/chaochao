    ...
    var CODEX = [
        ...
        },
        {
            ...
            entries: [
                ...
                { id: "hazard-movingbumper", name: "Moving Bumper", icon: art("bumper"), anim: "movingBumper",
                ...
                { id: "hazard-bumperwall", name: "Bumper Wall", icon: swatch("#F07B36"), anim: "bumperWall",
                ...
                { id: "hazard-rotor", name: "Rotor", icon: emoji("🎡"), anim: "rotor",
                ...
                { id: "hazard-geyser", name: "Geyser", icon: emoji("⛲"), anim: "geyser",
                ...
                { id: "hazard-mine", name: "Proximity Mine", icon: emoji("💣"), anim: "mine",
                ...
                { id: "hazard-antlion", name: "Antlion", icon: svg("bug-solid.svg"), anim: "antlion",
                  ...
                  detail: "Spend more than a moment on sand and an antlion bursts from a nearby dune to chase you — standing your ground just summons more. They never kill you directly; they shove, and a shove at the wrong moment slides you into lava or off your line. They're a touch slower than a kart on good ground, they burrow back under after a few seconds off the sand, and they can't cross water — a pool is a wall to them. (Mostly seen in the Antlions brutal round.)" },
                { id: "hazard-thumper", name: "Thumper", icon: emoji("🔨"), anim: "thumper",
                ...
                { id: "hazard-vortexwell", name: "Vortex Well", icon: emoji("🌀"), anim: "vortexWell",
                ...
                { id: "hazard-lasergate", name: "Laser Gate", icon: swatch("#42E0FF"), anim: "laserGate",
                ...
                { id: "hazard-crusher", name: "Crusher", icon: swatch("#9AA0A6"), anim: "crusher",
                ...
                { id: "hazard-sentryturret", name: "Sentry Turret", icon: emoji("🔫"), anim: "sentryTurret",
                ...
                { id: "hazard-magpiedrone", name: "Magpie Drone", icon: emoji("🐦"), anim: "magpieDrone",
        ...
        },
        {
            ...
            label: "Boons",
            entries: [
                { id: "boon-dasharrows", name: "Dash Arrows", icon: emoji("⏩"), anim: "dashArrows",
                ...
                { id: "boon-rechargespring", name: "Recharge Spring", icon: emoji("🔋"), anim: "rechargeSpring",
                ...
                { id: "boon-slipstream", name: "Slipstream", icon: emoji("💨"), anim: "slipstream",
                ...
                { id: "boon-guardhalo", name: "Guard Halo", icon: emoji("🛡️"), anim: "guardHalo",
                ...
                { id: "boon-secondwindtotem", name: "Second Wind Totem", icon: emoji("🚩"), anim: "secondWindTotem",
                  blurb: "Attune to a flag and respawn there on death.",
                  detail: "A respawn flag you drive over to attune to. Once you're attuned, every death that round respawns you at the flag instead of ending your run — over and over, for as long as the flag survives. The death plays as a beat: you freeze, the camera pans to the flag, and you reappear there with a moment of grace. The flag burns up the instant the collapsing lava reaches it, so it won't save you forever — and in team modes a flag respawn costs your team nothing (only a real death does)." },
                { id: "boon-launchpad", name: "Launch Pad", icon: emoji("🚀"), anim: "launchPad",
                ...
                { id: "boon-barrelcannon", name: "Barrel Cannon", icon: emoji("🛢️"), anim: "barrelCannon",
                ...
                { id: "boon-slingshotrings", name: "Slingshot Rings", icon: emoji("💫"), anim: "slingshotRings",
                ...
                { id: "boon-warppad", name: "Warp Pad", icon: emoji("🔮"), anim: "warpPad",
                ...
                { id: "boon-zipline", name: "Zipline", icon: emoji("🚠"), anim: "zipline",
                ...
                { id: "boon-lilypad", name: "Lily Pads", icon: emoji("🪷"), anim: "lilyPad",
