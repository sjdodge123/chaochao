        ...
        },
        {
            ...
            entries: [
                { id: "medal-intro", name: "About Medals", icon: emoji("🏅"), anim: "medalShine",
                  ...
                  detail: "When the match wraps, the game looks back over everything that happened and hands out medals for how each racer played — who racked up kills, who kept reaching the goal, who couldn't catch a break. They're bragging rights, awarded automatically. While you race, a little ticker in the bottom-left corner tracks your progress toward the skill medals in real time: pull off a kill, a fully-charged punch, a bumper bounce, an ability, a zombie bite or a tough finish and a bar pops up showing how close you are (\"Heavy Hitter 3 / 4\"), lighting up gold the moment you've done enough this match." },
